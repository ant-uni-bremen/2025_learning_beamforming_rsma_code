...
if __name__ == '__main__':
    ...
    data_paths = [
        Path(cfg.output_metrics_path,
             '01_user_distance_without_error', '01_mixed_objective_1',
             'testing_rsma_genie_sweep_500_50000.gzip'),
        Path(cfg.output_metrics_path,
             '01_user_distance_without_error','01_mixed_objective_2',
        ...
        Path(cfg.output_metrics_path,
             '01_user_distance_without_error', '01_mixed_objective_2',
             'testing_learned_rsma_power_common_usersweep_500_50000_5.599.gzip'),
