...
if __name__ == '__main__':
    ...
    data_paths = [
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', 'with_error',
             'testing_rsma_usersweep_alpha_0_0_50000.gzip'),
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', 'with_error',
             'testing_rsma_usersweep_alpha_0.5_0_50000.gzip'),
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', 'with_error',
             'testing_rsma_usersweep_alpha_0.75_0_50000.gzip'),
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', 'with_error',
             'testing_rsma_usersweep_alpha_1_0_50000.gzip'),
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', 'with_error',
             'testing_learned_rsma_power_factor_usersweep_with_error_0_50000.gzip'),
        Path(cfg.output_metrics_path,
             'test', 'distance_sweep', #'with_error',
