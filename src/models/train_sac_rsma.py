...
def train_sac_RSMA(
    ...
    config.config_learner.algorithm_args['network_args']['num_actions'] = 2 * config.sat_nr * config.sat_ant_nr * config.user_nr + 2 * config.sat_nr * config.sat_ant_nr
